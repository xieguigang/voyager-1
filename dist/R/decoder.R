...
let decode as function(start as integer, wavFile as string = goldenRecord, saveImg = "./img.png") {
	using wav as read.wav(file = file(wavFile), lazy = TRUE) {
		...
		let first_circle = new image.chunk(channel = "Left", start = start, length = 1928181);
